...
func (inst *Mint) SetCollectionAuthorityRecordAccount(collectionAuthorityRecord ag_solanago.PublicKey) *Mint {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(collectionAuthorityRecord)
	return inst
}
...
func (inst *Mint) SetCollectionMintAccount(collectionMint ag_solanago.PublicKey) *Mint {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(collectionMint)
	return inst
}
...
func (inst *Mint) SetCollectionMetadataAccount(collectionMetadata ag_solanago.PublicKey) *Mint {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(collectionMetadata).WRITE()
	return inst
}
...
func (inst *Mint) SetCollectionMasterEditionAccount(collectionMasterEdition ag_solanago.PublicKey) *Mint {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(collectionMasterEdition)
	return inst
}
...
func (inst *Mint) SetCollectionUpdateAuthorityAccount(collectionUpdateAuthority ag_solanago.PublicKey) *Mint {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(collectionUpdateAuthority)
	return inst
}
...
func (inst *Mint) SetRecentSlothashesAccount(recentSlothashes ag_solanago.PublicKey) *Mint {
	inst.AccountMetaSlice[17] = ag_solanago.Meta(recentSlothashes)
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("Mint")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=19]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("           collectionMint", inst.AccountMetaSlice.Get(10)))
						accountsBranch.Child(ag_format.Meta("       collectionMetadata", inst.AccountMetaSlice.Get(11)))
						accountsBranch.Child(ag_format.Meta("  collectionMasterEdition", inst.AccountMetaSlice.Get(12)))
						accountsBranch.Child(ag_format.Meta("collectionUpdateAuthority", inst.AccountMetaSlice.Get(13)))
						...
						accountsBranch.Child(ag_format.Meta("         recentSlothashes", inst.AccountMetaSlice.Get(17)))
