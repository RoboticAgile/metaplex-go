...
var (
	...
	Instruction_MintNftOcp = ag_binary.TypeID([8]byte{208, 148, 53, 19, 83, 242, 22, 159})

	Instruction_MintNftMip1 = ag_binary.TypeID([8]byte{170, 99, 244, 193, 68, 174, 73, 50})
	...
	Instruction_Freeze = ag_binary.TypeID([8]byte{255, 91, 207, 84, 251, 194, 254, 63})

	Instruction_Thaw = ag_binary.TypeID([8]byte{226, 249, 34, 57, 189, 21, 177, 101})

	Instruction_UpdateFreezeState = ag_binary.TypeID([8]byte{77, 25, 61, 8, 1, 174, 52, 56})
)
...
func InstructionIDToName(id ag_binary.TypeID) string {
	...
	case Instruction_MintNft:
		return "MintNft"
	case Instruction_MintNftOcp:
		return "MintNftOcp"
	case Instruction_MintNftMip1:
		return "MintNftMip1"
	case Instruction_MintNftLite:
		return "MintNftLite"
	...
	case Instruction_Thaw:
		return "Thaw"
	case Instruction_UpdateFreezeState:
...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		...
		{
			"mint_nft_ocp", (*MintNftOcp)(nil),
		},
		{
			"mint_nft_mip1", (*MintNftMip1)(nil),
		},
		{
		...
		{
			"update_freeze_state", (*UpdateFreezeState)(nil),
		},
	},
)
