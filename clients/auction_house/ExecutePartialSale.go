...
func (inst ExecutePartialSale) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_ExecutePartialSale,
	}}
}
...
func (inst *ExecutePartialSale) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		...
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("ExecutePartialSale")).
				//
...
func NewExecutePartialSaleInstruction(
	...
	return NewExecutePartialSaleInstructionBuilder().
