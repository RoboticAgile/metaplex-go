...
func (inst *AuctioneerWithdraw) SetAuctioneerAuthorityAccount(auctioneerAuthority ag_solanago.PublicKey) *AuctioneerWithdraw {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(auctioneerAuthority).SIGNER()
	return inst
}
...
func (inst AuctioneerWithdraw) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_AuctioneerWithdraw,
	}}
}
...
func (inst *AuctioneerWithdraw) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		...
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("AuctioneerWithdraw")).
				//
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=13]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("auctioneerAuthority", inst.AccountMetaSlice.Get(5)))
...
func NewAuctioneerWithdrawInstruction(
	...
	return NewAuctioneerWithdrawInstructionBuilder().
