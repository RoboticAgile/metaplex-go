...
func (obj AuctionHouse) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	...
	// Serialize `HasAuctioneer` param:
	err = encoder.Encode(obj.HasAuctioneer)
	if err != nil {
		return err
	}
	// Serialize `AuctioneerPdaBump` param:
	err = encoder.Encode(obj.AuctioneerPdaBump)
	if err != nil {
		return err
	}
	return nil
...
func (obj *AuctionHouse) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	...
	// Deserialize `HasAuctioneer`:
	err = decoder.Decode(&obj.HasAuctioneer)
	if err != nil {
		return err
	}
	// Deserialize `AuctioneerPdaBump`:
	err = decoder.Decode(&obj.AuctioneerPdaBump)
	if err != nil {
		return err
	}
	return nil
...
func (obj Auctioneer) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(AuctioneerDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `AuctioneerAuthority` param:
	err = encoder.Encode(obj.AuctioneerAuthority)
	if err != nil {
		return err
	}
	// Serialize `AuctionHouse` param:
...
func (obj *Auctioneer) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		...
		if !discriminator.Equal(AuctioneerDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
				"[46 101 92 150 138 30 245 120]",
				fmt.Sprint(discriminator[:]))
		}
	}
	// Deserialize `AuctioneerAuthority`:
	err = decoder.Decode(&obj.AuctioneerAuthority)
	if err != nil {
		return err
	}
	// Deserialize `AuctionHouse`:
