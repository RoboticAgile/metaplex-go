...
func (inst *EndAuction) SetAuctionExtendedDataAccount(auctionExtendedData ag_solanago.PublicKey) *EndAuction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(auctionExtendedData)
	return inst
}
...
func (inst *EndAuction) SetAuctionManagerAuthorityAccount(auctionManagerAuthority ag_solanago.PublicKey) *EndAuction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(auctionManagerAuthority).SIGNER()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("EndAuction")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=7]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("    auctionExtendedData", inst.AccountMetaSlice.Get(2)))
						accountsBranch.Child(ag_format.Meta("auctionManagerAuthority", inst.AccountMetaSlice.Get(3)))
