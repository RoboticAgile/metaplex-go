...
func (inst *UpdateLaunchStages) SetNotaryRequired(notaryRequired []bool) *UpdateLaunchStages {
	inst.NotaryRequired = &notaryRequired
	return inst
}
...
func (inst *UpdateLaunchStages) Validate() error {
	// Check whether all (required) parameters are set:
	{
		...
		if inst.NotaryRequired == nil {
			return errors.New("NotaryRequired parameter is not set")
		}
	}
			...
			programBranch.Child(ag_format.Instruction("UpdateLaunchStages")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Params[len=3]").ParentFunc(func(paramsBranch ag_treeout.Branches) {
						...
						paramsBranch.Child(ag_format.Param("NotaryRequired", *inst.NotaryRequired))
					})
...
func NewUpdateLaunchStagesInstruction(
	...
	return NewUpdateLaunchStagesInstructionBuilder().
		...
		SetNotaryRequired(notaryRequired).
