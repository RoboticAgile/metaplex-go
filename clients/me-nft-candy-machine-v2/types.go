...
func (obj *LaunchStage) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	...
	// Deserialize `WalletLimit`:
	{
		...
		switch tmp.Enum {
		case 0:
			obj.WalletLimit = (*WalletLimitSpecificationNoLimit)(&tmp.Enum)
		case 1:
			obj.WalletLimit = &tmp.FixedLimit
		case 2:
			obj.WalletLimit = (*WalletLimitSpecificationVariableLimit)(&tmp.Enum)
		default:
...
type walletLimitSpecificationContainer struct {
	...
	NoLimit       WalletLimitSpecificationNoLimit
	FixedLimit    WalletLimitSpecificationFixedLimit
	VariableLimit WalletLimitSpecificationVariableLimit
}
...
func (_ *WalletLimitSpecificationNoLimit) isWalletLimitSpecification() {}
...
func (_ *WalletLimitSpecificationVariableLimit) isWalletLimitSpecification() {}
