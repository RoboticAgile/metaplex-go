...
func (inst *MintV2) SetNftOwnerAccount(nftOwner ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(nftOwner)
	return inst
}
...
func (inst *MintV2) SetNftMintAccount(nftMint ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(nftMint).WRITE()
	return inst
}
...
func (inst *MintV2) SetNftMintAuthorityAccount(nftMintAuthority ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(nftMintAuthority).SIGNER()
	return inst
}
...
func (inst *MintV2) SetTokenAccount(token ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(token).WRITE()
	return inst
}
...
func (inst *MintV2) SetCollectionDelegateRecordAccount(collectionDelegateRecord ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(collectionDelegateRecord)
	return inst
}
...
func (inst *MintV2) SetCollectionMintAccount(collectionMint ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(collectionMint)
	return inst
}
...
func (inst *MintV2) SetCollectionMetadataAccount(collectionMetadata ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(collectionMetadata).WRITE()
	return inst
}
...
func (inst *MintV2) SetCollectionMasterEditionAccount(collectionMasterEdition ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(collectionMasterEdition)
	return inst
}
...
func (inst *MintV2) SetCollectionUpdateAuthorityAccount(collectionUpdateAuthority ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[15] = ag_solanago.Meta(collectionUpdateAuthority)
	return inst
}
...
func (inst *MintV2) SetSplTokenProgramAccount(splTokenProgram ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[17] = ag_solanago.Meta(splTokenProgram)
	return inst
}
...
func (inst *MintV2) SetSplAtaProgramAccount(splAtaProgram ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[18] = ag_solanago.Meta(splAtaProgram)
	return inst
}
...
func (inst *MintV2) SetSysvarInstructionsAccount(sysvarInstructions ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[20] = ag_solanago.Meta(sysvarInstructions)
	return inst
}
...
func (inst *MintV2) SetRecentSlothashesAccount(recentSlothashes ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[21] = ag_solanago.Meta(recentSlothashes)
	return inst
}
...
func (inst *MintV2) SetAuthorizationRulesAccount(authorizationRules ag_solanago.PublicKey) *MintV2 {
	inst.AccountMetaSlice[23] = ag_solanago.Meta(authorizationRules)
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("MintV2")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=24]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("                 nftOwner", inst.AccountMetaSlice.Get(4)))
						accountsBranch.Child(ag_format.Meta("                  nftMint", inst.AccountMetaSlice.Get(5)))
						accountsBranch.Child(ag_format.Meta("         nftMintAuthority", inst.AccountMetaSlice.Get(6)))
						...
						accountsBranch.Child(ag_format.Meta("                    token", inst.AccountMetaSlice.Get(9)))
						accountsBranch.Child(ag_format.Meta("              tokenRecord", inst.AccountMetaSlice.Get(10)))
						accountsBranch.Child(ag_format.Meta(" collectionDelegateRecord", inst.AccountMetaSlice.Get(11)))
						accountsBranch.Child(ag_format.Meta("           collectionMint", inst.AccountMetaSlice.Get(12)))
						accountsBranch.Child(ag_format.Meta("       collectionMetadata", inst.AccountMetaSlice.Get(13)))
						accountsBranch.Child(ag_format.Meta("  collectionMasterEdition", inst.AccountMetaSlice.Get(14)))
						accountsBranch.Child(ag_format.Meta("collectionUpdateAuthority", inst.AccountMetaSlice.Get(15)))
						accountsBranch.Child(ag_format.Meta("     tokenMetadataProgram", inst.AccountMetaSlice.Get(16)))
						accountsBranch.Child(ag_format.Meta("          splTokenProgram", inst.AccountMetaSlice.Get(17)))
						accountsBranch.Child(ag_format.Meta("            splAtaProgram", inst.AccountMetaSlice.Get(18)))
						accountsBranch.Child(ag_format.Meta("            systemProgram", inst.AccountMetaSlice.Get(19)))
						accountsBranch.Child(ag_format.Meta("       sysvarInstructions", inst.AccountMetaSlice.Get(20)))
						accountsBranch.Child(ag_format.Meta("         recentSlothashes", inst.AccountMetaSlice.Get(21)))
						accountsBranch.Child(ag_format.Meta("authorizationRulesProgram", inst.AccountMetaSlice.Get(22)))
						accountsBranch.Child(ag_format.Meta("       authorizationRules", inst.AccountMetaSlice.Get(23)))
					})
				})
		})
}
